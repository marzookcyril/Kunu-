...
<body>
        ...
        <div class="container-news">
            ...
            <div class="col-lg-8 col-md-10 mx-auto">
                ...
                <a href="bdv.php">
                    ...
                    L’espace naturiste du Bois de Vincennes est de retour !
                    </h3>
                </a>
                ...
                <div class="post-preview">
                <a href="nea.php">
                    <img src="palais-gla.jpg"/>
                    <h2 class="post-title">
                    « Nu et approuvé » : le spectacle naturiste qui arrive bientôt à Paris !
                    </h2>
                </a>
                <p class="post-meta">Posted by
                    <a href="#">Kunu</a>
                ...
                <!-- Pager -->
                <div class="clearfix">
                <a class="btn float-right" href="#" >Older Posts &rarr;</a>
                </div>
            </div>
            </div>
        </div>
    ...
    <!-- CALENDRIER -->
    <div class="section3" id="calendrier">
    ...
    <div class="contact" id="contact">
        ...
        <div class="container">
            ...
            <form action="/action_page.php" class="">
                ...
                <textarea id="subject" name="subject" placeholder="Votre message.." style="height:200px" class="areacontact"></textarea>
                <div class="envoyer">
